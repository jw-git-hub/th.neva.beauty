...
# разбора CSS, и жирный текст первого экрана (43 элемента на странице услуги)
# секунду держался на системном шрифте.
...
TYPOGRAPHY = "«»„“”‘’–—…№°©®×±§€₽•  ­́"
# Буквы из названий марок, которых нет в латинице без диакритики.
# é — L’Oréal в премиальных материалах (задача 123). É — заглавная пара к нему:
# в текстах пока не встречается, но взята заодно, чтобы «L’ORÉAL» в будущей
# правке или под text-transform:uppercase не вылезло системным шрифтом.
BRAND_LETTERS = "éÉ"
CHARSET = BASIC_LATIN + RUSSIAN + TYPOGRAPHY + BRAND_LETTERS
